...
When you access and use the Site, we automatically collect and store following information:
...
Under the GDPR, you have the following rights as a user of the Site:
